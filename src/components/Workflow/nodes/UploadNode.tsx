...
export default function UploadNode({ id, data, selected }: { id: string, data: any, selected: boolean }) {
  ...
  return (
    <>
      ...
      <div className={cn(
        "bg-[rgb(43,43,47)] border rounded-[16px] w-[460px] h-[558.8px] shadow-2xl flex flex-col group transition-all relative overflow-visible box-border pb-[55.8px]",
      ...
      >
        <div className="flex items-center justify-between pl-[16px] pr-[16px] pt-[22px] pb-[7px] h-[12px] shrink-0 mb-[6px] overflow-visible">
            <div className="flex items-center h-[12px]">
                <span className="text-[16px] font-semibold text-white leading-none">Image file</span>
            </div>
        ...
        >
            {data.image ? (
                 <div className="relative w-full h-full">
                     <img src={data.image} alt="Uploaded content" className="w-full h-full object-contain" />
                     <button 
